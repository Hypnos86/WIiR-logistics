...
class ContractListView(LoginRequiredMixin, View):
    method = 'ContractListView'
    template_name = 'contract/list_contract.html'
    ...
    def get(self, request):
        ...
        try:
            ...
            context = {'title': MainModule.contract.value, 'unit_group': unit_group, 'contract_group': contract_group,
